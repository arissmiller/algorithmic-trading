...
import { SIGNAL_META, SignalWeight } from "../lib/signals";
    ...
    <div className="h-full overflow-auto p-4">
      ...
      <section className="mb-4 rounded border border-border bg-surface-1">
        ...
        <div className="grid grid-cols-1 gap-3 p-4 lg:grid-cols-2">
          ...
          <div className="lg:col-span-2 rounded border border-border bg-surface-2 px-3 py-2">
            <p className="text-[10px] font-semibold uppercase tracking-widest text-text-secondary">
              Watchlist Backtesting Moved
            </p>
            <p className="mt-1 text-[10px] text-text-secondary">
              Run backtests across this watchlist from the Stocks/Crypto Backtesting screens using
              the new watchlist controls there.
            </p>
          </div>
        </div>
